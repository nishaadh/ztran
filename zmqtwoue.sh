...
curl -i -X POST -H "Content-type: application/json" -d '{"name":"secure_slice","allocation_policy":{"type":"proportional","share":64}}' http://${NEXRAN_XAPP}:8000/v1/slices ; echo ; echo
echo Listing Slices: ; echo
curl -i -X GET http://${NEXRAN_XAPP}:8000/v1/slices ; echo ; echo
...
curl -i -X POST http://${NEXRAN_XAPP}:8000/v1/nodebs/${NBNAME}/slices/secure_slice ; echo ; echo
echo "Getting NodeB (name=${NBNAME}):" ; echo
curl -i -X GET http://${NEXRAN_XAPP}:8000/v1/nodebs/${NBNAME} ; echo ; echo
